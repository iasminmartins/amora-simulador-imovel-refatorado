...
class SimulacaoCreate(BaseModel):
    ...
    valor_imovel: float = Field(..., ge=200000, le=6000000, description="Valor do imóvel deve ser maior que zero")
    percentual_entrada: float = Field(..., ge=5, le=100, description="Percentual de entrada entre 0 e 100")
